...
;---------第二时间更新------------------
;======================================
L_Update_Another_Time_Prog:
	LDA		R_Time_Sec
	BNE		L_Update_Another_Time_Prog_OUT
	JSR		L_Update_Another_Time_Min_Prog
	BCC		L_Update_Another_Time_Prog_OUT
	JSR		L_Update_Another_Time_Hr_Prog
L_Update_Another_Time_Prog_OUT:
	RTS

L_Update_Another_Time_Min_Prog:;时间分钟更新加
	LDX		#(R_Time_Min_Another-Time_Str_Addr)
	JMP		L_Inc_To_60_Prog
;---------------------------
L_Update_Another_Time_Hr_Prog:;时间小时更新加
